...
export const TriggerNode = ({ data, selected }: any) => {
  return (
    <div
      className={cn(
        "px-4 py-3 shadow-md rounded-lg bg-emerald-50 border-2",
...
export const StepNode = ({ data, selected }: any) => {
  return (
    <div
      className={cn(
        "px-4 py-3 shadow-md rounded-lg bg-blue-50 border-2 min-w-[200px]",
...
export const ConditionNode = ({ data, selected }: any) => {
  return (
    <div
      className={cn(
        "px-4 py-3 shadow-md rounded-lg bg-amber-50 border-2",
...
export const OutputNode = ({ data, selected }: any) => {
  return (
    <div
      className={cn(
        "px-4 py-3 shadow-md rounded-lg bg-zinc-50 border-2",
...
export const HumanApprovalNode = ({ data, selected }: any) => {
  return (
    <div
      className={cn(
        "px-4 py-3 shadow-md rounded-lg bg-purple-50 border-2 min-w-[200px]",
